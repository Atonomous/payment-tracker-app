            ...
            try {
                ...
                const unsubscribe = onAuthStateChanged(firebaseAuth, (user) => {
                    if (user) {
                        ...
                        // Fallback for anonymous sign-in if initial token fails or is not present
...
function App() {
    ...
    useEffect(() => {
        ...
        const paymentsCollectionRef = collection(db, `artifacts/${__app_id}/users/${userId}/payments`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingPayment) {
                ...
                const paymentRef = doc(db, `artifacts/${__app_id}/users/${userId}/payments`, editingPayment.id);
    ...
    const handleDelete = (paymentId) => {
        ...
        setModalAction(() => async () => {
            try {
                ...
                await deleteDoc(doc(db, `artifacts/${__app_id}/users/${userId}/payments`, paymentId));
